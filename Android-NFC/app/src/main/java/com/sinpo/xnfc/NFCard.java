...
public class NFCard extends Activity implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, " onCreate 00000000000000000000000000000000 ");
    ...
    protected void onPause() {
        super.onPause();
        Log.e(TAG, " onPause 0000000000000000000000000000");
        if (nfcAdapter != null)
    ...
    protected void onResume() {
        super.onResume();
        Log.e(TAG, " onResume 000000000000000000000000000");
        if (nfcAdapter != null)
...
//        String info = ByteArrayChange.ByteArrayToHexString(bytesId) + "\n";
//        Log.e(TAG, "标签UID:  " + "\n" + info);
