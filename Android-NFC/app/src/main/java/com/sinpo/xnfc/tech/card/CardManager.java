...
public final class CardManager {
	...
	static String TAG = "060_CardManager";
	...
	public static String load(Parcelable parcelable, Resources res) {
		final Tag tag = (Tag) parcelable;  //获取NFC标签TAG
		final IsoDep isodep = IsoDep.get(tag);  //获取NFC标签id？标签唯一标识

		Log.e(TAG, "ffff  isodep :" + isodep);//isodep.transceive("45".getBytes()).toString());
		
		if (isodep != null) {
			Log.e(TAG, "isodep != null" );
